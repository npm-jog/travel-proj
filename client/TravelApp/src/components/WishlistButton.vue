<template>
  <ion-button class="wishlist-button" v-if="!inWishlist" color="success" @click="addToWishlist"
    >+ wishlist <ion-icon slot="end" icon="flag"></ion-icon
  ></ion-button>
  <ion-button class="wishlist-button remove-button" color="danger" v-else @click="removeFromWishlist"
    >- wishlist <ion-icon slot="end" icon="flag"></ion-icon
  ></ion-button>
</template>
